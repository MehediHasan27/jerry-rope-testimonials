...
| The music | Three grooves are synthesised in WebAudio — no audio files, no licence, and the scheduler knows the tempo. Or load your own track and it is routed through the same analyser. Bass energy drives beat detection; her head nod, shoulder sway and the sound arcs leaving her headphones all read from that, so she is moving to the actual audio. Damped while she is hauling — she is working, after all. |
